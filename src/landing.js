...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #modo-info { display: none; margin: 10px 2px; padding: 8px 12px; border-radius: 8px; font-size: .8rem; background: var(--amarelo); color: #7a5c00; }
...
async function perguntar() {
  ...
  try {
    ...
    elModo.className = '';
    if (d.modo === 'regras') { elModo.style.display = 'block'; elModo.className = ''; elModo.textContent = '⚠ Modo offline (sem IA) — a responder pelas regras internas.'; }
    else if (d.modo === 'llm') { elModo.style.display = 'block'; elModo.className = 'off'; elModo.textContent = '🤖 Assistido por IA.'; }
