...
function renderDados(container, dados) {
  ...
  if (dados && typeof dados === 'object') {
    ...
    if (Array.isArray(dados.partidos) && dados.partidos.length) renderPartidosChart(container, dados.partidos, dados.foco);
    ...
    for (const chave of Object.keys(dados)) {
      ...
      if (Array.isArray(arr) && arr.length && typeof arr[0] === 'object') {
        const chaves = Object.keys(arr[0]).filter(k => k !== 'id');
